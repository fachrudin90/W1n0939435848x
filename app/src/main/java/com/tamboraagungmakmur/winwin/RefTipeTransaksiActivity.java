...
import com.tamboraagungmakmur.winwin.Adapter.RefTipeTransaksiAdapter;
...
public class RefTipeTransaksiActivity extends AppCompatActivity {

    private static final String TAG = "REF_TIPE_TRANSAKSI";

    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private RefTipeTransaksiAdapter adapter;
    private ArrayList<RefTipeTransaksi> dataArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ref_tipe_transaksi);
        context = RefTipeTransaksiActivity.this;
        requestQueue = Volley.newRequestQueue(context);
        initView();
        getTemplate();

        LocalBroadcastManager.getInstance(context).registerReceiver(mMessageReceiver,
                new IntentFilter("ref_tipe_transaksi"));
    }
    ...
    private void initView() {
        ...
        adapter = new RefTipeTransaksiAdapter(dataArrayList);
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, RefTipeTransaksiAddActivity.class);
