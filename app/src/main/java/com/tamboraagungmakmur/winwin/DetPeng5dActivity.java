...
public class DetPeng5dActivity extends FragmentActivity {

    private final static String TAG = "DET_PENG5D";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = DetPeng5dActivity.this;
    ...
    private void ok() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_PENGAJUAN_BADDEBT + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
...
//                    Toast.makeText(context, logoutResponse.getMessage(), Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(context, "Pengajuan nomor " + nopeng + " (" + nama + ") Bad Debt Diaktifkan!", Toast.LENGTH_LONG).show();
