...
public class InvestasrikAddActivity extends FragmentActivity {

    private static final Object TAG = "INVESTARIK_ADD";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = InvestasrikAddActivity.this;
    ...
    private void initView() {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.jenis_tarik, android.R.layout.simple_spinner_item);
    ...
    private void edit() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_INVESTASI_INVESTARIK + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
