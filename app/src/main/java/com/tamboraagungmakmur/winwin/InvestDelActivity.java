...
public class InvestDelActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = InvestDelActivity.this;
    ...
    private void ok() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.DELETE, AppConf.URL_INVESTASI_INVEST + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
