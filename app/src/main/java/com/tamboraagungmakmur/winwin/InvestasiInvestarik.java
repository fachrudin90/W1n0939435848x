...
import com.tamboraagungmakmur.winwin.Adapter.InvestarikAdapter;
...
public class InvestasiInvestarik extends android.support.v4.app.Fragment {
    ...
    private InvestarikAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            view = inflater.inflate(R.layout.fragment_investasi_investarik, container, false);
        ...
        intent.putExtra("message", "List Permintaan Tarikan");
        LocalBroadcastManager.getInstance(view.getContext()).sendBroadcast(intent);

        recyclerView = (RecyclerView) view.findViewById(R.id.rvList);
        linearLayoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter = new InvestarikAdapter(investasiInvestorArrayList);
    ...
    private void initView() {
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, InvestasrikAddActivity.class);
    ...
    private void getKlien() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTARIK + "/" + LIMIT + "/" + offset + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void getKlien(final String tg11, final String tgl2) {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTARIK + "/" + LIMIT + "/" + offset + "/" + tg11 + "/" + tgl2 + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void cari(final String cari) {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTARIK_FIND + "/" + cari + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
