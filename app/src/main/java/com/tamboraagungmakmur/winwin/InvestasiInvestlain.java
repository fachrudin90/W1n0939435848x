...
import com.tamboraagungmakmur.winwin.Adapter.InvestlainAdapter;
import com.tamboraagungmakmur.winwin.Model.Investlain;
import com.tamboraagungmakmur.winwin.Model.InvestlainResponse;
...
public class InvestasiInvestlain extends android.support.v4.app.Fragment {

    private static final Object TAG = "INVESTASI_INVESTLAIN";
    ...
    private InvestlainAdapter adapter;
    private ArrayList<Investlain> investasiInvestorArrayList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            view = inflater.inflate(R.layout.fragment_investasi_investlain, container, false);
        ...
        intent.putExtra("message", "List Transaksi Lain");
        LocalBroadcastManager.getInstance(view.getContext()).sendBroadcast(intent);

        recyclerView = (RecyclerView) view.findViewById(R.id.rvList);
        linearLayoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter = new InvestlainAdapter(investasiInvestorArrayList);
    ...
    private void initView() {
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, InvestlainAddActivity.class);
    ...
    private void getKlien() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTLAIN + "/" + LIMIT + "/" + offset + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    InvestlainResponse klienResponse = new Gson().fromJson(jsonObject1.toString(), InvestlainResponse.class);
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void getKlien(final String tg11, final String tgl2) {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTLAIN + "/" + LIMIT + "/" + offset + "/" + tg11 + "/" + tgl2 + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void cari(final String cari) {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTLAINFIND + "/" + cari + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
