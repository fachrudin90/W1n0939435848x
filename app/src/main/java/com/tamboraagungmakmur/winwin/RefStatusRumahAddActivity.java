...
public class RefStatusRumahAddActivity extends FragmentActivity {

    private static final Object TAG = "REF_STATUS_RUMAH_ADD";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RefStatusRumahAddActivity.this;
...
//        id = getIntent().getStringExtra("id");
    ...
    private void edit() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_REF_STATUS_RUMAH_STORE + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
...
//                    finish();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("ref_stts_rmh_id", txNoid.getText().toString());
