...
public class RefKotaEditActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ref_kota_edit);
        context = RefKotaEditActivity.this;
    ...
    private void initView() {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.status_kota, android.R.layout.simple_spinner_item);
    ...
    private void getDetail() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_REF_KOTA_DETAIL + "/" + id1 + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void edit() {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_REF_KOTA_UPDATE + "/" + id1 + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//                    finish();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                if (spinner1.getSelectedItemPosition() == 0) {
                    params.put("tolak", "true");
                } else {
                    params.put("tolak", "false");
                }
                return params;
            }
        };
