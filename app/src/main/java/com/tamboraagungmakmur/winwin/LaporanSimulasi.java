...
import com.tamboraagungmakmur.winwin.Model.SimulasiResponse;
...
//    EditText txPencarian;
    ...
    private ArrayList<Simulasi> taskArrayList = new ArrayList<>();
    ...
    private Call<SimulasiResponse> call;
    private AsyncTask<String, Void, String> insertdb;

    public LaporanSimulasi() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            view = inflater.inflate(R.layout.fragment_laporan_simulasi1, container, false);
        ...
        intent.putExtra("message", "Laporan Simulasi");
        LocalBroadcastManager.getInstance(view.getContext()).sendBroadcast(intent);

        total.setText("Total Laporan Simulasi: 0");
        ...
        adapter = new SimulasiAdapter(taskArrayList);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_LOGSIMULASI_ALL + "/" + tgl1 + "/" + tgl2 + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    SimulasiResponse klienResponse = new Gson().fromJson(jsonObject1.toString(), SimulasiResponse.class);

//                    JSONArray jsonArray = new JSONArray(klienResponse.getData().toString());
                    if (klienResponse.getData().length != 0) {

                        if (total != null) {
                            total.setText("Total Laporan Simulasi: " + klienResponse.getCount());
                        }
...
//                            db.addSimulasi(klienResponse.getData()[i]);
