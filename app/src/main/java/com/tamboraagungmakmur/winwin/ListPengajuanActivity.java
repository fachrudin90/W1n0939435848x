...
public class ListPengajuanActivity extends Activity {

    private final static String TAG = "LIST_PENGAJUAN";
    ...
    private void getPengajuan() {
        ...
        SessionManager sessionManager = new SessionManager(ListPengajuanActivity.this);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENGAJUAN_ALL + "/" + LIMIT + "/" + offset + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
...
//                        Klien klien = new Gson().fromJson(jsonObject.toString(), Klien.class);
                    ...
                    e.printStackTrace();
                    GlobalToast.ShowToast(ListPengajuanActivity.this, getString(R.string.session_expired));

                    SessionManager sessionManager = new SessionManager(ListPengajuanActivity.this);
                    sessionManager.logoutUser(); sessionManager.setPage(0);

                    Intent intent = new Intent(ListPengajuanActivity.this, LoginActivity.class);
                    ListPengajuanActivity.this.startActivity(intent);
                    ListPengajuanActivity.this.finish();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof TimeoutError) {
                    Toast.makeText(ListPengajuanActivity.this, "timeout", Toast.LENGTH_SHORT).show();
                } else if (error instanceof NoConnectionError) {
                    Toast.makeText(ListPengajuanActivity.this, "no connection", Toast.LENGTH_SHORT).show();
                } else {
...
//        VolleyHttp.getInstance(ListPengajuanActivity.this).addToRequestQueue(stringRequest);
    ...
    private void getPengajuan1(final String cari) {
        ...
        SessionManager sessionManager = new SessionManager(ListPengajuanActivity.this);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENGAJUAN_FIND + query + "/" + LIMIT + "/" + offset + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
