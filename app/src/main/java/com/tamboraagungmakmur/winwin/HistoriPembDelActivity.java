...
public class HistoriPembDelActivity extends FragmentActivity {

    private final static String TAG = "HISTORI_PEMB_DEL";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_histpembdel);
        context = HistoriPembDelActivity.this;
