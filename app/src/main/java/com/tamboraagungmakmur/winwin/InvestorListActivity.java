...
import com.tamboraagungmakmur.winwin.Adapter.InvestorListAdapter;
...
public class InvestorListActivity extends FragmentActivity {

    private static final Object TAG = "INVESTOR_LIST";
    ...
    protected void onCreate (Bundle bundle) {
        ...
        context = InvestorListActivity.this;
        requestQueue = Volley.newRequestQueue(context);

        recyclerView = (RecyclerView) findViewById(R.id.rvlist);
        linearLayoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter = new InvestorListAdapter(investasiInvestorArrayList);
