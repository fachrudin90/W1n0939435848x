...
public class HistoriDendDelActivity extends FragmentActivity {

    private final static String TAG = "HISTORI_DEND_DEL";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_histdenddel);
        context = HistoriDendDelActivity.this;
