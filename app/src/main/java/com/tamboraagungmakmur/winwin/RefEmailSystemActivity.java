...
import com.tamboraagungmakmur.winwin.Adapter.EmailTempAdapter;
...
public class RefEmailSystemActivity extends AppCompatActivity {

    private static final String TAG = "REF_EMAIL_SYSTEM";

    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private EmailTempAdapter adapter;
    private ArrayList<EmailTemplate> dataArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_system);
        context = RefEmailSystemActivity.this;
        requestQueue = Volley.newRequestQueue(context);
        initView();
        getTemplate();

        LocalBroadcastManager.getInstance(context).registerReceiver(mMessageReceiver,
                new IntentFilter("ref_email_system"));
    }
    ...
    private void initView() {
        ...
        adapter = new EmailTempAdapter(dataArrayList);
    ...
    private void getTemplate() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_REF_EMAIL_SYSTEM + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
