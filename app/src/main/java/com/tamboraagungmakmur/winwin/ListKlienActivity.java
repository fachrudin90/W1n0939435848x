...
import com.tamboraagungmakmur.winwin.Adapter.Klien1Adapter;
...
public class ListKlienActivity extends Activity {

    private final static String TAG = "LIST_KLIEN";
    private RequestQueue requestQueue;

    private ArrayList<Klien> pengajuanArrayList = new ArrayList<>();
    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private Klien1Adapter pengajuanAdapter;
    ...
    private void initView() {
        ...
        pengajuanAdapter = new Klien1Adapter(pengajuanArrayList);
    ...
    private void getPengajuan() {
        ...
        SessionManager sessionManager = new SessionManager(ListKlienActivity.this);
...
//                        Klien klien = new Gson().fromJson(jsonObject.toString(), Klien.class);
                    ...
                    e.printStackTrace();
                    GlobalToast.ShowToast(ListKlienActivity.this, getString(R.string.session_expired));

                    SessionManager sessionManager = new SessionManager(ListKlienActivity.this);
                    sessionManager.logoutUser(); sessionManager.setPage(0);

                    Intent intent = new Intent(ListKlienActivity.this, LoginActivity.class);
                    ListKlienActivity.this.startActivity(intent);
                    ListKlienActivity.this.finish();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof TimeoutError) {
                    Toast.makeText(ListKlienActivity.this, "timeout", Toast.LENGTH_SHORT).show();
                } else if (error instanceof NoConnectionError) {
                    Toast.makeText(ListKlienActivity.this, "no connection", Toast.LENGTH_SHORT).show();
                } else {
...
//        VolleyHttp.getInstance(ListKlienActivity.this).addToRequestQueue(stringRequest);
