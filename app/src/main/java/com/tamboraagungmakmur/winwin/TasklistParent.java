...
import com.tamboraagungmakmur.winwin.Adapter.TaskListAdapter;
 ...
 */
public class TasklistParent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            view = inflater.inflate(R.layout.fragment_tasklist_parent, container, false);
        ...
        adapter = new TaskListAdapter(mActivity, taskArrayList);
...
//        GetData();
    ...
    private void GetData() {
        ...
        for (int i = 0; i < 15; i++) {
            ...
            TaskListModel taskListModel = new TaskListModel("2017-03-01", "Analisa", "0432-20020-135325 Richy", "Sherly", "Analisa", "Aktif");
            dataSet.add(taskListModel);
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btAdd:
                ...
                Fragment frag = new AddTaskListFragment();
    ...
    private void getTask() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_TASK_ALL + "/" + LIMIT + "/" + offset + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
...
//                    JSONArray jsonArray = new JSONArray(klienResponse.getData().toString());
                    if (klienResponse.getData().length != 0) {
                        ...
                        if (total != null) {
                            total.setText("Total Task: " + klienResponse.getCount());
                        }
...
//        VolleyHttp.getInstance(mActivity).addToRequestQueue(stringRequest);
    ...
    private void getTask1(final String tgl1, final String tgl2) {
        ...
        SessionManager sessionManager = new SessionManager(mActivity);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_TASK_ALL + "/" + LIMIT + "/" + offset + "/" + tgl1 + "/" + tgl2 + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//        VolleyHttp.getInstance(mActivity).addToRequestQueue(stringRequest);
    ...
    private void getTask2(final String cari) {
        ...
        SessionManager sessionManager = new SessionManager(mActivity);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_TASK_FIND + query + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
