...
import com.tamboraagungmakmur.winwin.Adapter.Investarik1Adapter;
import com.tamboraagungmakmur.winwin.Model.Investarik;
import com.tamboraagungmakmur.winwin.Model.InvestarikResponse;
...
public class InvestasiInvestcair extends android.support.v4.app.Fragment {

    private static final Object TAG = "INVESTASI_INVESTARIK";
    ...
    private Investarik1Adapter adapter;
    private ArrayList<Investarik> investasiInvestorArrayList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            view = inflater.inflate(R.layout.fragment_investasi_investcair, container, false);
        ...
        intent.putExtra("message", "List Pencairan Bunga & Pokok");
        LocalBroadcastManager.getInstance(view.getContext()).sendBroadcast(intent);

        recyclerView = (RecyclerView) view.findViewById(R.id.rvList);
        linearLayoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter = new Investarik1Adapter(investasiInvestorArrayList);
    ...
    private void initView() {
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, InvestcairAddActivity.class);
    ...
    private void getKlien() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTARIK1 + "/" + LIMIT + "/" + offset + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    InvestarikResponse klienResponse = new Gson().fromJson(jsonObject1.toString(), InvestarikResponse.class);
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void getKlien(final String tg11, final String tgl2) {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTARIK1 + "/" + LIMIT + "/" + offset + "/" + tg11 + "/" + tgl2 + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void cari(final String cari) {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTARIK_FIND1 + "/" + cari + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
