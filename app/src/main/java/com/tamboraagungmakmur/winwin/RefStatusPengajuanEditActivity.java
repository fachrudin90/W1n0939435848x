...
public class RefStatusPengajuanEditActivity extends FragmentActivity {

    private static final Object TAG = "REF_STATUS_PENGAJUAN_EDIT";
    @Bind(R.id.save)
    Button save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RefStatusPengajuanEditActivity.this;
    ...
    private void getDetail() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_REF_STATUS_PENGAJUAN_DETAIL + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    RefStatusPengajuan klienResponse = new Gson().fromJson(jsonObject1.getString("data"), RefStatusPengajuan.class);

                    if (klienResponse != null) {
                        txJenisKode.setText(klienResponse.getAjustat_code());
                        txJenisLabel.setText(klienResponse.getAjustat_label());

                        if(klienResponse.getWajib().equalsIgnoreCase("Tidak Diterima")){
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void edit() {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_REF_STATUS_PENGAJUAN_UPDATE + "/"+id+"?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
