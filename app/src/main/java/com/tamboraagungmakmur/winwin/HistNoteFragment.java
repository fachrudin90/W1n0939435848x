...
public class HistNoteFragment extends Fragment {

    private final static String TAG = "HIST_NOTE";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            view = inflater.inflate(R.layout.fragment_histnote, container, false);
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.rv_histnote);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENGAJUAN_DETAIL + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (pengajuanDetail.getData().getNotes().length > 0) {
                        for (int i=0; i<pengajuanDetail.getData().getNotes().length; i++) {
                            historiTahapanArrayList.add(pengajuanDetail.getData().getNotes()[i]);
