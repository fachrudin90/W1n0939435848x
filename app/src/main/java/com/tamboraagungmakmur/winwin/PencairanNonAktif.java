...
/**
 * Created by innan on 8/16/2017.
 */

public class PencairanNonAktif extends Fragment {
...
//        });
    ...
    private void getPengajuan() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENCAIRAN_NON_AKTIF + "/" + LIMIT + "/" + offset + "?_session=" + sessionId, new Response.Listener<String>() {
            @Override
...
//                DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
    ...
    private void getPengajuan2(final String cari) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENCAIRAN_FINDNONAKTIF + query + "?_session=" + sessionId, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
