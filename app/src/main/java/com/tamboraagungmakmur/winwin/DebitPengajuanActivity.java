...
public class DebitPengajuanActivity extends FragmentActivity {

    private final static String TAG = "DEBIT_PENGAJUAN";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = DebitPengajuanActivity.this;
...
//        VolleyHttp.getInstance(DebitPengajuanActivity.this).getRequestQueue().cancelAll(AppConf.httpTag);
        super.onStop();
    }
    ...
    private void getKlien() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_DEBITBCA_MATCH + "/" + idUpload + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
