...
import com.tamboraagungmakmur.winwin.Model.InvestorDetResponse;
...
public class InvestorEditActivity extends FragmentActivity {

    private final static String TAG = "INVESTOR_EDIT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = InvestorEditActivity.this;
    ...
    private void pickImage(int code) {
        if (ContextCompat.checkSelfPermission(context,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(InvestorEditActivity.this,
                    android.Manifest.permission.READ_EXTERNAL_STORAGE)) {
                ...
                ActivityCompat.requestPermissions(InvestorEditActivity.this,
...
//        super.onActivityResult(requestCode, resultCode, data);
    ...
    private void getKlien() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVESTOR_DET + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    InvestorDetResponse klienResponse = new Gson().fromJson(jsonObject1.toString(), InvestorDetResponse.class);


                    for (int i=0; i<klienResponse.getData().getDocs().length; i++) {
                        String img = AppConf.BASE_URL_IMG + "/home/investors/" + klienResponse.getData().getInvestor_nomor_investor() + "/" + klienResponse.getData().getDocs()[i].getInv_doc_file();
                        if (klienResponse.getData().getDocs()[i].getInv_doc_type_id().compareTo("1") == 0) {
                            Log.d("ktp", img);
                            Glide.with(context)
                                    .load(img)
                                    .asBitmap()
                                    .placeholder(R.drawable.placeholder)
                                    .into(ktp);
                        } else if (klienResponse.getData().getDocs()[i].getInv_doc_type_id().compareTo("11") == 0) {
                            Glide.with(context)
                                    .load(img)
                                    .asBitmap()
                                    .placeholder(R.drawable.placeholder)
                                    .into(foto);
                        } else if (klienResponse.getData().getDocs()[i].getInv_doc_type_id().compareTo("21") == 0) {
                            Glide.with(context)
                                    .load(img)
                                    .asBitmap()
                                    .placeholder(R.drawable.placeholder)
                                    .into(npwp);
                        } else if (klienResponse.getData().getDocs()[i].getInv_doc_type_id().compareTo("7") == 0) {
                            Glide.with(context)
                                    .load(img)
                                    .asBitmap()
                                    .placeholder(R.drawable.placeholder)
                    ...
                    email.setText(klienResponse.getData().getInvestor_email());
                    name.setText(klienResponse.getData().getInvestor_nama());
                    alamat.setText(klienResponse.getData().getInvestor_alamat());
                    phone.setText(klienResponse.getData().getInvestor_handphone());
                    norek.setText(klienResponse.getData().getInvestor_nomor_rekening());
...
//                    finish();
    ...
    private void edit() {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_INVESTASI_INVESTOR + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
