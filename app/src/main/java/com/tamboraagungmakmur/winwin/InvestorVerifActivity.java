...
public class InvestorVerifActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = InvestorVerifActivity.this;
    ...
    private void initView() {
        ...
        text1 = (TextView) findViewById(R.id.text1);
            ...
            text1.setText("Set Terverifikasi?");
    ...
    private void ok() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_INVESTASI_INVESTOR_VERIF + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
