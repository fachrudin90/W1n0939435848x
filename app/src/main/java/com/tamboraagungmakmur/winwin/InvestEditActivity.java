...
import com.tamboraagungmakmur.winwin.Model.InvestDetResponse;
...
public class InvestEditActivity extends FragmentActivity {

    private static final Object TAG = "INVEST_EDIT";
    private Context context;
    private String id;
    private RequestQueue requestQueue;

    private EditText tgl1, tgl2;
    private TextInputEditText nominal, note;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = InvestEditActivity.this;
    ...
    private void getKlien() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_INVESTASI_INVEST_DET + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    InvestDetResponse klienResponse = new Gson().fromJson(jsonObject1.toString(), InvestDetResponse.class);

                    tgl1.setText(klienResponse.getData().getInvest_tgl_terima());
                    tgl2.setText(klienResponse.getData().getInvest_tgl_start());
                    nominal.setText(klienResponse.getData().getInvest_nominal());
                    note.setText(klienResponse.getData().getInvest_catatan_bukti());
...
//                    finish();
    ...
    private void edit() {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_INVESTASI_INVEST + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
