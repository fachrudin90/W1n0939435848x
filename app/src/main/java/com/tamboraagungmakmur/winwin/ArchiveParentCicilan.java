...
public class ArchiveParentCicilan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPagerAdapter.addFragments(new PinjamanCicilan(), getString(R.string.pengajuan));
        viewPagerAdapter.addFragments(new PencairanCicilan(), getString(R.string.pencarian));
        viewPagerAdapter.addFragments(new PembayaranCicilan(), getString(R.string.pembayaran));
        viewPagerAdapter.addFragments(new PerpanjanganCicilan(), getString(R.string.perpanjangan));
        viewPagerAdapter.addFragments(new DendaCicilan(), getString(R.string.denda));
        ...
        vPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                switch (position) {
                    case 0:
                        message = "Pengajuan Cicilan";
                        break;
                    case 1:
                        message = "Pencairan Cicilan";
                        break;
                    case 2:
                        message = "Pembayaran Cicilan";
                        break;
                    case 3:
                        message = "Perpanjangan Cicilan";
                        break;
                    case 4:
                        message = "Denda Cicilan";
                        break;
                }
