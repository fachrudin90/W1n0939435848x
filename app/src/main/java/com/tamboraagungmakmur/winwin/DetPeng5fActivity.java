...
public class DetPeng5fActivity  extends FragmentActivity{

    private final static String TAG = "DET_PENG5F";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = DetPeng5fActivity.this;
    ...
    private void initView() {
        ...
        text1.setText("Kembalikan pengajuan ke Bayar Sebagian?");
    ...
    private void ok() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_PENGAJUAN_BADDEBT1 + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
...
//                    Toast.makeText(context, logoutResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    Toast.makeText(context, "Pengajuan nomor " + nopeng + " (" + nama + ") Bad Debt Dihentikan!", Toast.LENGTH_LONG).show();
