...
public class ArchiveParent3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPagerAdapter.addFragments(new PinjamanLunas(), getString(R.string.pengajuan));
        viewPagerAdapter.addFragments(new PencairanLunas(), getString(R.string.pencarian));
        viewPagerAdapter.addFragments(new PembayaranLunas(), getString(R.string.pembayaran));
        viewPagerAdapter.addFragments(new PerpanjanganLunas(), getString(R.string.perpanjangan));
        viewPagerAdapter.addFragments(new DendaLunas(), getString(R.string.denda));
        ...
        vPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                switch (position) {
                    case 0:
                        message = "Pengajuan Lunas";
                        break;
                    case 1:
                        message = "Pencairan Lunas";
                        break;
                    case 2:
                        message = "Pembayaran Lunas";
                        break;
                    case 3:
                        message = "Perpanjangan Lunas";
                        break;
                    case 4:
                        message = "Denda Lunas";
                        break;
