 ...
 */
public class ArchiveParent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPagerAdapter.addFragments(new ArchivePengajuan(), getString(R.string.pengajuan));
        viewPagerAdapter.addFragments(new ArchivePencarian(), getString(R.string.pencarian));
        viewPagerAdapter.addFragments(new ArchivePembayaran(), getString(R.string.pembayaran));
        viewPagerAdapter.addFragments(new ArchivePerpanjangan(), getString(R.string.perpanjangan));
        viewPagerAdapter.addFragments(new ArchiveDenda(), getString(R.string.denda));
