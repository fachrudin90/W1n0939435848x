...
public class ReqJBActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_req_jb);
        ButterKnife.bind(this);
        dari = "";
        context = ReqJBActivity.this;
        requestQueue = Volley.newRequestQueue(context);
        id = getIntent().getStringExtra("id");
        idpeng = getIntent().getStringExtra("idPeng");
        progressDialog = new ProgressDialog(ReqJBActivity.this);
...
//        SessionManager sessionManager = new SessionManager(mActivity);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_REQ_JB, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!klienResponse.isError()) {
                        ...
                        LocalBroadcastManager.getInstance(ReqJBActivity.this).sendBroadcast(new Intent("req_jb"));
//                        kembali();
...
//                    finish();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                SessionManager sessionManager = new SessionManager(ReqJBActivity.this);
