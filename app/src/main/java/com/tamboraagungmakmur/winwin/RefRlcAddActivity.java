...
public class RefRlcAddActivity extends FragmentActivity {

    private static final Object TAG = "REF_RLC_ADD";
    @Bind(R.id.text1)
    TextView text1;
    @Bind(R.id.view1)
    View view1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RefRlcAddActivity.this;
...
//        id = getIntent().getStringExtra("id");
    ...
    private void edit() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_REF_RLC_STORE + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
