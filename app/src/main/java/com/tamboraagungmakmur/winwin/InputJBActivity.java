...
public class InputJBActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dari = "";
        context = InputJBActivity.this;
        requestQueue = Volley.newRequestQueue(context);
        id = getIntent().getStringExtra("id");
        idpeng = getIntent().getStringExtra("idPeng");
        progressDialog = new ProgressDialog(InputJBActivity.this);
...
//        SessionManager sessionManager = new SessionManager(mActivity);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_INPUT_JB, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!klienResponse.isError()) {
                        ...
                        LocalBroadcastManager.getInstance(InputJBActivity.this).sendBroadcast(new Intent("req_jb"));
//                        kembali();
                        ...
                        Toast.makeText(context, "gagal mengaktifkan janji bayar", Toast.LENGTH_SHORT).show();
                    }
...
//                    finish();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                SessionManager sessionManager = new SessionManager(InputJBActivity.this);
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btSimpan:
                if (txTgl.getText().toString().isEmpty()) {
                    GlobalToast.ShowToast(InputJBActivity.this, "Masukkan tanggal");
                } else {
                    reqJb();
                }
                break;
