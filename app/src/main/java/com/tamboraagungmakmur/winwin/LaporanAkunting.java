...
import com.tamboraagungmakmur.winwin.Adapter.AkuntingAdapter;
import com.tamboraagungmakmur.winwin.Model.Akunting;
import com.tamboraagungmakmur.winwin.Model.AkuntingResponse;
 ...
 */
public class LaporanAkunting extends Fragment {
...
//    EditText txPencarian;
    ...
    private final static String TAG = "LAPORAN_AKUNTING";
    ...
    private ArrayList<Akunting> taskArrayList = new ArrayList<>();
    ...
    private Call<AkuntingResponse> call;
    private AsyncTask<String, Void, String> insertdb;

    public LaporanAkunting() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            view = inflater.inflate(R.layout.fragment_laporan_akunting, container, false);
        ...
        intent.putExtra("message", "Laporan Akunting");
        LocalBroadcastManager.getInstance(view.getContext()).sendBroadcast(intent);

        total.setText("Total Laporan Akunting: 0");
        ...
        adapter = new AkuntingAdapter(taskArrayList);
...
//                Log.d("internals", internals.get(0).getKlien());
                ...
                sqliteToExcel.exportSingleTable("akunting", "akunting_"+txTgl1.getText().toString()+"_"+txTgl2.getText().toString()+".xls", new SQLiteToExcel.ExportListener() {
                    @Override
                    public void onStart() {
...
//        GetData();
    ...
    private void getTask(final String tgl1, final String tgl2) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_LOGACCOUNTING_ALL + "/" + tgl1 + "/" + tgl2 + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    AkuntingResponse klienResponse = new Gson().fromJson(jsonObject1.toString(), AkuntingResponse.class);

//                    JSONArray jsonArray = new JSONArray(klienResponse.getData().toString());
                    if (klienResponse.getData().length != 0) {

                        if (total != null) {
                            total.setText("Total Laporan Akunting: " + klienResponse.getCount());
                        }
...
//                            db.addAkunting(klienResponse.getData()[i]);
    ...
    private class InsertDb extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            for (int i = 0 ; i < taskArrayList.size(); i++) {
                db.addAkunting(taskArrayList.get(i));
            }
