...
public class ArchivePengajuanBayarSebagianAdapter extends RecyclerView.Adapter<ArchivePengajuanBayarSebagianAdapter.MyViewHolder> {
    ...
    public ArchivePengajuanBayarSebagianAdapter(Context context, ArrayList<Pengajuan> data) {
        this.dataSet = data;
...
//        holder.txBayar.setText(new FormatPrice().format(value.getBase_bill()) + "\nSisa: " + new FormatPrice().format(value.getTotal_bill()));
        ...
        holder.btView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("dari", "Bayar Sebagian");
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                context.startActivity(intent);
            }
        });
