...
public class RefJenisPembayaranAdapter extends RecyclerView.Adapter<RefJenisPembayaranAdapter.EmailTempViewHolder> {

    private ArrayList<RefJenisPembayaran> dataArrayList;
    private Context context;

    public RefJenisPembayaranAdapter(ArrayList<RefJenisPembayaran> dataArrayList) {
        this.dataArrayList = dataArrayList;
    }

    @Override
    public EmailTempViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ref_jenis_pembayaran, parent, false);
    ...
    public void onBindViewHolder(EmailTempViewHolder holder, final int position) {
        ...
        final RefJenisPembayaran value = dataArrayList.get(position);
...
//                context.startActivity(intent);
    ...
    public class EmailTempViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView no,  namaLabel, namaCode, status;
