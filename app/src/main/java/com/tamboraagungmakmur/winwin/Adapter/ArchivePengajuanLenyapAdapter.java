...
public class ArchivePengajuanLenyapAdapter extends RecyclerView.Adapter<ArchivePengajuanLenyapAdapter.MyViewHolder> {
    ...
    public ArchivePengajuanLenyapAdapter(Context context, ArrayList<Pengajuan> data) {
        this.dataSet = data;
...
//        holder.txBayar.setText(new FormatPrice().format(value.getBase_bill()) + "\nSisa: " + new FormatPrice().format(value.getTotal_bill()));
        ...
        holder.btView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("dari", context.getString(R.string.lenyap));
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                context.startActivity(intent);
            }
        });
