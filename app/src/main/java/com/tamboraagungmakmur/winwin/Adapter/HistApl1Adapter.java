...
public class HistApl1Adapter extends RecyclerView.Adapter<HistApl1Adapter.HistAplViewHolder> {
    ...
    public HistApl1Adapter(ArrayList<PengajuanDetailData> pengajuanDetailDataArrayList) {
    ...
    public HistAplViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_histapl1, parent, false);
