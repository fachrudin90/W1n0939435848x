...
public class RefSyaratDaftarAdapter extends RecyclerView.Adapter<RefSyaratDaftarAdapter.EmailTempViewHolder> {

    private ArrayList<RefSyaratDaftar> dataArrayList;
    private Context context;

    public RefSyaratDaftarAdapter(ArrayList<RefSyaratDaftar> dataArrayList) {
        this.dataArrayList = dataArrayList;
    }

    @Override
    public EmailTempViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ref_syarat_daftar, parent, false);
    ...
    public void onBindViewHolder(EmailTempViewHolder holder, final int position) {
        ...
        final RefSyaratDaftar value = dataArrayList.get(position);
