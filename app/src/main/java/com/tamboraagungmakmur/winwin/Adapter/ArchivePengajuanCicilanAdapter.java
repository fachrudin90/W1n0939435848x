...
public class ArchivePengajuanCicilanAdapter extends RecyclerView.Adapter<ArchivePengajuanCicilanAdapter.MyViewHolder> {
    ...
    public ArchivePengajuanCicilanAdapter(Context context, ArrayList<Pengajuan> data) {
        this.dataSet = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_pengajuan_lunas, parent, false);
...
//        holder.txStatus.setText(value.getStatus() + "\n" + value.getTahap());
        ...
        holder.btView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("dari", context.getString(R.string.cicilan));
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                context.startActivity(intent);
            }
        });
