...
public class ArchivePengajuanAdapter extends RecyclerView.Adapter<ArchivePengajuanAdapter.MyViewHolder> {
    ...
    public ArchivePengajuanAdapter(Context context, ArrayList<Pengajuan> data) {
        this.dataSet = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_pengajuan, parent, false);
...
//        holder.txBayar.setText(new FormatPrice().format(value.getBase_bill()) + "\nSisa: " + new FormatPrice().format(value.getTotal_bill()));
        ...
        if (value.getTahap().compareTo("Pencairan Sudah, Pinjaman Aktif") == 0) {
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.d("pengajuan_baru_loading", "ok1");
            isLast = true;
