...
public class ArchivePengajuan1Adapter extends RecyclerView.Adapter<ArchivePengajuan1Adapter.MyViewHolder> {
    ...
    public ArchivePengajuan1Adapter(Context context, ArrayList<Pengajuan> data) {
        this.dataSet = data;
