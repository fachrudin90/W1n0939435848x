...
import com.tamboraagungmakmur.winwin.Model.PengajuanSelect;
...
public class ArchivePengajuan1AdapterSelectAll extends RecyclerView.Adapter<ArchivePengajuan1AdapterSelectAll.MyViewHolder> {


    private ArrayList<Pengajuan> dataSet;
    private ArrayList<Boolean> dataSelect;
    ...
    public ArchivePengajuan1AdapterSelectAll(Context context, ArrayList<Pengajuan> data, ArrayList<Boolean> dataSelect) {
        this.dataSet = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_pengajuan2, parent, false);
...
//        holder.txBayar.setText(new FormatPrice().format(value.getBase_bill()) + "\nSisa: " + new FormatPrice().format(value.getTotal_bill()));
        ...
        if (!dataSelect.get(listPosition)) {
        ...
        holder.btDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, PengDeleteActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.putExtra("id", value.getId());
                context.startActivity(intent);
            }
        ...
        holder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (b != dataSelect.get(listPosition)) {
                    dataSelect.set(listPosition, b);
                    Intent intent = new Intent("pengajuan_pilih");
                    intent.putExtra("id", value.getId());
