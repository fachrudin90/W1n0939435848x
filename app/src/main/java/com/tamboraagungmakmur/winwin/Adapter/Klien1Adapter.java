...
public class Klien1Adapter extends RecyclerView.Adapter<Klien1Adapter.PengajuanViewHolder> {

    private ArrayList<Klien> listPengajuan;
    private Context context;

    public Klien1Adapter(ArrayList<Klien> listPengajuan) {
    ...
    public void onBindViewHolder(PengajuanViewHolder holder, int position) {
        ...
        holder.txPengajuan.setText(pengajuan.getNomor_pelanggan() + " " + pengajuan.getNama_lengkap() + " [" + pengajuan.getEmail() + "]");
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("email", pengajuan.getEmail());
