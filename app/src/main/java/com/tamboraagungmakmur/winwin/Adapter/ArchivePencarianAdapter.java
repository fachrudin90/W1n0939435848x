...
public class ArchivePencarianAdapter extends RecyclerView.Adapter<ArchivePencarianAdapter.MyViewHolder> {
    ...
    public ArchivePencarianAdapter(Context context, ArrayList<Pencairan> data) {
        this.dataSet = data;
