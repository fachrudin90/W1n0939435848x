...
public class ArchivePengajuanJanjiBayarAdapter extends RecyclerView.Adapter<ArchivePengajuanJanjiBayarAdapter.MyViewHolder> {
    ...
    public ArchivePengajuanJanjiBayarAdapter(Context context, ArrayList<Pengajuan> data) {
        this.dataSet = data;
