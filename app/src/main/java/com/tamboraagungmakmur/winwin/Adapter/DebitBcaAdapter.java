...
public class DebitBcaAdapter extends RecyclerView.Adapter<DebitBcaAdapter.TestimoniViewHolder> {

    public DebitBcaAdapter(ArrayList<KreditBca> testimonis) {
    ...
    public void onBindViewHolder(TestimoniViewHolder holder, final int position) {
        ...
        holder.klien.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DebitPengajuanActivity.class);
