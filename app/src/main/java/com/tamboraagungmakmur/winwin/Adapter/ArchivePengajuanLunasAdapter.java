...
public class ArchivePengajuanLunasAdapter extends RecyclerView.Adapter<ArchivePengajuanLunasAdapter.MyViewHolder> {
    ...
    public ArchivePengajuanLunasAdapter(Context context, ArrayList<Pengajuan> data) {
        this.dataSet = data;
