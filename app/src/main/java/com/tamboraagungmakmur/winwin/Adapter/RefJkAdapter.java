...
public class RefJkAdapter extends RecyclerView.Adapter<RefJkAdapter.EmailTempViewHolder> {

    private ArrayList<RefJk> dataArrayList;
    private Context context;

    public RefJkAdapter(ArrayList<RefJk> dataArrayList) {
        this.dataArrayList = dataArrayList;
    }

    @Override
    public EmailTempViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ref_jk, parent, false);
    ...
    public void onBindViewHolder(EmailTempViewHolder holder, final int position) {
        ...
        final RefJk value = dataArrayList.get(position);

        holder.no.setText("" + (position+1));
        holder.namaLabel.setText(value.getSex_label());
        holder.namaCode.setText(value.getSex_code());
        holder.manWoman.setText(value.getSexisman());
...
//                context.startActivity(intent);
    ...
    public class EmailTempViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView no, namaLabel, namaCode, manWoman, status;
        ...
        public EmailTempViewHolder(View itemView) {
            ...
            manWoman = (TextView) itemView.findViewById(R.id.manWoman);
