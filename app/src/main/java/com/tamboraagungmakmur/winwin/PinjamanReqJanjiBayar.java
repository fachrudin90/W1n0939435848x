...
import com.tamboraagungmakmur.winwin.Adapter.ArchivePengajuanReqJanjiBayarAdapter;
...
public class PinjamanReqJanjiBayar extends Fragment {
    ...
    private final static String TAG = "PENGAJUAN_REQUEST_JANJI_BAYAR";
    ...
    public void onResume() {
        ...
        intent.putExtra("message", "Request Janji Bayar");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            view = inflater.inflate(R.layout.fragment_pinjaman_req_janji_bayar, container, false);
        ...
        title.setText(getResources().getString(R.string.pengajuan_req_janji_bayar));
        total.setText("Total Request Janji Bayar : 0");
        ...
        adapter = new ArchivePengajuanReqJanjiBayarAdapter(mActivity, klienArrayList);
...
//                    saveFile(txPencarian.getText().toString().replace(" ", "+"));
    ...
    private void getPengajuan() {
        Log.d("pengajuan_jbj", AppConf.URL_PENGAJUAN_JANJI_BAYAR + "/" + LIMIT + "/" + offset + "?_session=" + sessionId);

        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENGAJUAN_REQ_JANJI_BAYAR + "/" + LIMIT + "/" + offset + "?_session=" + sessionId, new Response.Listener<String>() {
            @Override
...
//                    JSONArray jsonArray = new JSONArray(klienResponse.getData().toString());
                    if (klienResponse.getData().length != 0) {
                        ...
                        if (total != null) {
                            total.setText("Total Request Janji Bayar: " + klienResponse.getCount());
                        }
...
//        VolleyHttp.getInstance(mActivity).addToRequestQueue(stringRequest);
    ...
    private void getPengajuan1(final String tgl1, final String tgl2) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENGAJUAN_REQ_JANJI_BAYAR + "/" + LIMIT + "/" + offset + "/" + tgl1 + "/" + tgl2 + "?_session=" + sessionId, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//        VolleyHttp.getInstance(mActivity).addToRequestQueue(stringRequest);
    ...
    private void getPengajuan_() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENGAJUAN_REQ_JANJI_BAYAR1 + "/" + LIMIT + "/" + offset + "?_session=" + sessionId, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//        VolleyHttp.getInstance(mActivity).addToRequestQueue(stringRequest);
    ...
    private void getPengajuan1_(final String tgl1, final String tgl2) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENGAJUAN_REQ_JANJI_BAYAR1 + "/" + LIMIT + "/" + offset + "/" + tgl1 + "/" + tgl2 + "?_session=" + sessionId, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//        VolleyHttp.getInstance(mActivity).addToRequestQueue(stringRequest);
    ...
    private void getPengajuan2(final String cari) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_PENGAJUAN_FIND_REQ_JANJI_BAYAR + query + "?_session=" + sessionId, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//        VolleyHttp.getInstance(mActivity).addToRequestQueue(stringRequest);
    ...
    private void saveFile(final String cari) {
        ...
        AndLog.ShowLog("PinjamBayar", "Cari");
        ...
        call = service.upload(AppConf.URL_PENGAJUAN_FIND_REQ_JANJI_BAYAR + "/" + cari + "?_session=" + sessionManager.getSessionId());
...
//                Log.d("share foto", response.body());
                ...
                AndLog.ShowLog("PinjamBayar", klienResponse.getCode());
...
//                        adapter.notifyDataSetChanged();
            ...
            public void onFailure(Call<PengajuanResponse> call, Throwable t) {
                ...
                AndLog.ShowLog("PinjamBayar", t.getMessage());
                if (call.isCanceled()) {
