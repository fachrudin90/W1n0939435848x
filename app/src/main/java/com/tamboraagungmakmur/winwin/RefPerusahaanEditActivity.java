...
public class RefPerusahaanEditActivity extends FragmentActivity {

    private static final Object TAG = "REF_PERUSAHAAN_EDIT";
    @Bind(R.id.text1)
    TextView text1;
    @Bind(R.id.view1)
    View view1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RefPerusahaanEditActivity.this;
    ...
    private void getDetail() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_REF_PERUSAHAAN_DETAIL + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    RefPerusahaan klienResponse = new Gson().fromJson(jsonObject1.getString("data"), RefPerusahaan.class);

                    if (klienResponse != null) {
                        txNama.setText(klienResponse.getNama_perusahaan());
                        txAlamat.setText(klienResponse.getAlamat());
                        txKota.setText(klienResponse.getKota());
                        txProvinsi.setText(klienResponse.getProvinsi());
                        txNoTelp.setText(klienResponse.getTelepon());
                        txJenisIndustri.setText(klienResponse.getJenis_industri());
                        txKomoditi.setText(klienResponse.getJenis_komoditi());
                        if (klienResponse.getStat_rlc().equalsIgnoreCase("APPROVED")) {
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void edit() {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_REF_PERUSAHAAN_UPDATE + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
