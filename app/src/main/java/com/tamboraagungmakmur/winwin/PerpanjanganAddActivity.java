...
public class PerpanjanganAddActivity extends FragmentActivity {

    private final static String TAG = "PERPANJANGAN_ADD";
    ...
    private TextInputEditText date, duration, catatan;
    private Button save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_perpanjangan);
        context = PerpanjanganAddActivity.this;
    ...
    private void initView() {
        ...
        duration = (TextInputEditText) findViewById(R.id.durasi);
        catatan = (TextInputEditText) findViewById(R.id.catatan);
    ...
    private void add() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_PERPANJANGAN_STORE + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
...
//                    finish();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("start", date.getText().toString());
                params.put("duration", duration.getText().toString());
                params.put("note", catatan.getText().toString());
                return params;
            }
        };
