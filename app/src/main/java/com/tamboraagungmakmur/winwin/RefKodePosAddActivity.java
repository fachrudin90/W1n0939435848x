...
public class RefKodePosAddActivity extends FragmentActivity {

    private static final Object TAG = "REF_KODEPOS_ADD";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RefKodePosAddActivity.this;
...
//        id = getIntent().getStringExtra("id");
    ...
    private void edit() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_REF_KODEPOS_STORE + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
