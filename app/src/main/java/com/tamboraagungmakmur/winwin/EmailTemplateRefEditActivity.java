...
import com.tamboraagungmakmur.winwin.Model.EmailTemplateResponse1;
...
public class EmailTemplateRefEditActivity extends FragmentActivity {
...
//    private KnifeText knifeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = EmailTemplateRefEditActivity.this;
...
//        knifeText = (KnifeText) findViewById(R.id.isi);
...
// with an action named "custom-event-name" is broadcasted.
    ...
    private void addTemplate() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_EMAIL_TEMPLATE_UPDATE + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!klienResponse.isError()) {
                        Toast.makeText(context, "Template telah diubah", Toast.LENGTH_SHORT).show();
...
//        VolleyHttp.getInstance(context).addToRequestQueue(stringRequest);
    ...
    private void getTemplate() {
        ...
        SessionManager sessionManager = new SessionManager(context);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConf.URL_EMAIL_TEMPLATE_DETAIL + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    JSONObject jsonObject1 = new JSONObject(response);
                    EmailTemplateResponse1 klienResponse = new Gson().fromJson(jsonObject1.toString(), EmailTemplateResponse1.class);

                    subjek.setText(klienResponse.getData().getLabel());
                    message.setText(klienResponse.getData().getKonten());
//                    knifeText.fromHtml(klienResponse.getData().getKonten());
//                    knifeText.setSelection(knifeText.getEditableText().length());
                    isi.setHtml(klienResponse.getData().getKonten());
