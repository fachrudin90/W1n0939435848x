...
public class LogActivityDetail {
    ...
    private String stat_total_catatan_pengajuan;
    ...
    public LogActivityDetail() {
    }

    public String getStat_total_catatan_pengajuan() {
        return stat_total_catatan_pengajuan;
    }

    public void setStat_total_catatan_pengajuan(String stat_total_catatan_pengajuan) {
        this.stat_total_catatan_pengajuan = stat_total_catatan_pengajuan;
    }
}
