...
public class ArchiveParent2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPagerAdapter.addFragments(new PinjamanNonAktif(), getString(R.string.pengajuan));
//        viewPagerAdapter.addFragments(new PencairanNonAktif(), getString(R.string.pencarian));
//        viewPagerAdapter.addFragments(new PembayaranNonAktif(), getString(R.string.pembayaran));
//        viewPagerAdapter.addFragments(new PerpanjanganNonAktif(), getString(R.string.perpanjangan));
//        viewPagerAdapter.addFragments(new DendaNonAktif(), getString(R.string.denda));
