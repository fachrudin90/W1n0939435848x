...
public class EmailTemplateRefActivity extends AppCompatActivity {

    private static final String TAG = "EMAIL_TEMPLATE";

    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private EmailTempAdapter adapter;
    private ArrayList<EmailTemplate> emailTemplateArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_template_ref);
        context = EmailTemplateRefActivity.this;
        requestQueue = Volley.newRequestQueue(context);
        initView();
        getTemplate();

        LocalBroadcastManager.getInstance(context).registerReceiver(mMessageReceiver,
                new IntentFilter("email_template"));
    }
    ...
    private void initView() {
        ...
        adapter = new EmailTempAdapter(emailTemplateArrayList);
