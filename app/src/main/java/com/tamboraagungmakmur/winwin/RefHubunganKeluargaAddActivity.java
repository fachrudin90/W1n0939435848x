...
public class RefHubunganKeluargaAddActivity extends FragmentActivity {

    private static final Object TAG = "REF_HUB_KELUARGA_ADD";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RefHubunganKeluargaAddActivity.this;
...
//        id = getIntent().getStringExtra("id");
    ...
    private void edit() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_REF_HUB_KLGR_STORE + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
