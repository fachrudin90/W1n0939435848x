...
/**
 * Created by innan on 9/18/2017.
 */

public class PindahTahap2aActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tahap2a);
        context = PindahTahap2aActivity.this;
    ...
    private void getPengajuanDetail() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_PENGAJUAN_DECISSION + "/" + id + "/setujui" + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!logoutResponse.isError()) {
                        ...
                        LocalBroadcastManager.getInstance(PindahTahap2aActivity.this).sendBroadcast(intent);

                        Intent intent1 = new Intent("tahap");
                        LocalBroadcastManager.getInstance(PindahTahap2aActivity.this).sendBroadcast(intent1);
