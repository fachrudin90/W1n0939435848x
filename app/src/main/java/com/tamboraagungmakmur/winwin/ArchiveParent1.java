...
public class ArchiveParent1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPagerAdapter.addFragments(new PinjamanAktif(), getString(R.string.pengajuan));
        ...
        vPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                switch (position) {
                    case 0:
                        message = "Pengajuan Aktif";
                        break;
                    case 1:
                        message = "Pencairan Aktif";
                        break;
                    case 2:
                        message = "Pembayaran Aktif";
                        break;
                    case 3:
                        message = "Perpanjangan Aktif";
                        break;
                    case 4:
                        message = "Denda Aktif";
                        break;
