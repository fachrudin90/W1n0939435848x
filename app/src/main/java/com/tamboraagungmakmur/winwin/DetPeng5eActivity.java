...
public class DetPeng5eActivity extends FragmentActivity {

    private final static String TAG = "DET_PENG5E";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = DetPeng5eActivity.this;
    ...
    private void initView() {
        ...
        text1.setText("Kembalikan pengajuan ke Collection?");
    ...
    private void ok() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PATCH, AppConf.URL_PENGAJUAN_BADDEBT2 + "/" + id + "?_session=" + sessionManager.getSessionId(), new Response.Listener<String>() {
            @Override
