...
public class InvestcairAddActivity extends FragmentActivity {

    private static final Object TAG = "INVESTCAIR_ADD";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = InvestcairAddActivity.this;
    ...
    private void initView() {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.jenis_tarik1, android.R.layout.simple_spinner_item);
